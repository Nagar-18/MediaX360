...
const About = () => {
 ...
 style={{ backgroundImage:`url(${about}) `, backgroundSize:"100vw 100vh"}} >
    ...
    <Header/>
    <div className='flex h-4/6  flex-col w-full  mr-9  sm:mt-24 mt-20 sm:mx-44 '>
       <p className=' sm:text-2xl  m-16 sm:m-0 sm:mr-80 text-white'>MediaX360 works to build strong and truthful
...
Content for all!</p>
    ...
    <div  className='flex w-full justify-center mb-24  sm:mb-3'>  <a target='_blank' href="#" className="inline-flex items-center justify-center px-2 mx-2 py-2 text-sm font-medium text-center text-white  rounded-lg  border-2 border-cyan-400 hover:bg-pink-500">
