...
const Home = () => {
 ...
 style={{ backgroundImage:`url(${neon}) `, backgroundSize:"100vw 100vh"}} >
    ...
    <div className='flex h-4/6  flex-col  w-4/5  sm:mt-32 ml-10 mr-80  mt-36 sm:mx-60 '>
       <p className=' sm:text-5xl  mx-20 mt-3 text-2xl gap-10  sm:mr-80 text-white'>Creating Smart And
        Engaging videos that 
      deliver the right content.</p>
        
      
    </div>
    <div  className='flex w-full justify-center  mb-36  sm:mb-3 '>  <a target='_blank' href="#" className="inline-flex items-center justify-center px-2 mx-2 py-2 text-sm font-medium text-center text-white  rounded-lg  border-2 border-cyan-400 hover:bg-pink-500">
