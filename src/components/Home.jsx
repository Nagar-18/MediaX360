...
const Home = () => {
 ...
 style={{ backgroundImage:`url(${neon}) `, backgroundSize:"100vw 100vh"}} >
    ...
    <div  className='flex w-full justify-center mb-32  sm:mb-3 '>  <a target='_blank' href="#" className="inline-flex items-center justify-center px-2 mx-2 py-2 text-sm font-medium text-center text-white  rounded-lg  border-2 border-cyan-400 hover:bg-pink-500">
